...
{With all of the tweets circulating every second it is hard to tell 
whether the sentiment behind a specific tweet will impact a company, 
or a person's, brand for being viral (positive), or devastate profit 
because it strikes a negative tone. 
\begin{itemize}
\item What's the \textcolor{orange}{Sentiment}  of this tweet.
\item What's the part of the tweet (\textcolor{orange}{word or phrase}) that reflects the sentiment.
\end{itemize}
}}
...
\toprule
ID & \texttt{text}  & \texttt{selected_text} & \texttt{sentiment} \\
\midrule
$cb774db0d1$
&  { Uh oh, I am sunburned} &  {I am sunburned} &  {negative}  \\
$549e992a42$
&  { We saw that the baddie`s the best} &  {best}&  {positive} \\
$f84b89a828$
&  {Sounds like me} &  {Sounds like me}&  {neutral} \\
\bottomrule
\end{tabular}
\end{center}
\bigskip
...
\begin{itemize}
  ...
  \item
  It can be seen that the number of three kinds of data is relatively average. 
  In addition, there are more neutral texts.
  \end{itemize}

\end{itemize}

 \begin{center}
    \includegraphics[scale=0.5]{D:/filp/program/twitter.git/data/number.eps}
 \end{center}
%%==========================================================================================
% \begin{note}
...
%   \begin{itemize}
%     \item
%     Let's take a look at the proportion of each category of text in another visualization method.
    
%     \begin{itemize}
%     \item
%     Most of them are neutral emotions,has 40.5 present.Positive are 31.2 persent.Negetive are 28.3 persent.
%     \end{itemize}
  
%   \end{itemize}
  
%   \begin{center}
%       \includegraphics[scale=0.5]{D:/filp/program/twitter.git/data/persent.eps}
%   \end{center}
% \end{slide}  
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.55]{D:/filp/program/twitter.git/data/length.eps}
  \end{center}
\end{slide}
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.38]{D:/filp/program/twitter.git/data/possel.eps}
  \end{center}
\end{slide}  
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.55]{D:/filp/program/twitter.git/data/clwpos.eps}
  \end{center}
\end{slide}  
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.38]{D:/filp/program/twitter.git/data/neusel.eps}
  \end{center}
\end{slide}  
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.55]{D:/filp/program/twitter.git/data/clwnet.eps}
  \end{center}
\end{slide}
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.38]{D:/filp/program/twitter.git/data/negsel.eps}
  \end{center}
\end{slide}  
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.55]{D:/filp/program/twitter.git/data/clwneg.eps}
  \end{center}
\end{slide}
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.55]{D:/filp/program/twitter.git/data/positive.eps}
  \end{center}
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.55]{D:/filp/program/twitter.git/data/neutral.eps}
  \end{center}
...
\begin{slide}[toc=,bm=]{Data Visualization}
  ...
  \begin{center}
      \includegraphics[scale=0.55]{D:/filp/program/twitter.git/data/negative.eps}
  \end{center}
...
\begin{slide}[]{Model:CRF+LSTM}
  ...
  \begin{center}
      \includegraphics[scale=0.55]{D:/filp/program/twitter.git/data/mlp.eps}
  \end{center}

\end{slide} 

\begin{slide}[toc=,bm=]{Model:CRF+LSTM}

    \begin{itemize}
    \item
    Based on our previous data visualization.We set the MAX_LEN = 48.
    \item
...
\begin{slide}[toc=,bm=]{Model:CRF+LSTM}
  ...
  \begin{center}
      \includegraphics[scale=0.45]{D:/filp/program/twitter.git/data/modelone.eps}
  \end{center}
  
  \begin{itemize}
    \item
    Finally, the accuracy of the trained model is 0.5393.
   \end{itemize}
...
\begin{slide}[]{Model:roBERTa}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item
      With bigger batchsize and more data, let the model train longer.
      \item
...
\begin{slide}[toc=,bm=]{Model:roBERTa}
  \begin{itemize}
    \item
    Activation function is “softmax”.
    \item
  ...
  \begin{center}
      \includegraphics[scale=0.4]{D:/filp/program/twitter.git/data/ro.eps}
  \end{center}
...
\begin{slide}[toc=,bm=]{Model:roBERTa}
  \begin{itemize}
    ...
    The loss function is “categorical_crossentropy”.
    \item
    Using k-fold cross validation, it is divided into five parts. Train three times.
    \end{itemize}
  \end{slide} 
  ...
  \begin{slide}[toc=,bm=]{Model:roBERTa}
    ...
    \begin{center}
        \includegraphics[scale=0.6]{D:/filp/program/twitter.git/data/modeltwo.eps}
    \end{center}
    
    \begin{itemize}
      \item
      Finally, the accuracy of the trained model is 0.7072782233322157.
     \end{itemize}
